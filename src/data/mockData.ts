...
export const HOSPITALS: Hospital[] = [
  ...
  },
  {
    ...
    offeredDepartments: {
      'Medicine & Physician Specialties': ['Diabetes', 'Endocrinology', 'Diabetology', 'Diabetic Foot Care', 'Hypertension']
    }
  },
  {
    id: 'hosp-3',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&w=800&q=80',
    address: 'Bengaluru',
    description: 'Advanced medical simulation center providing clinical training through high-fidelity simulation technology.',
    clinicalHighlights: [
      'Advanced simulation-based medical training',
      'Clinical skill development programs',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=800&q=80',
    address: 'Hyderabad',
    description: 'Tertiary care hospital in Hyderabad recognized for advanced critical care and multidisciplinary treatment.',
    clinicalHighlights: [
