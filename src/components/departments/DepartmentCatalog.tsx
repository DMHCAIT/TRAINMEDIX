                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {dept.subDepartments.slice(0, 3).map((sub, sIdx) => (
                            <span
                              key={sIdx}
                              className="bg-slate-100 border border-slate-200/80 text-slate-800 text-[10px] px-2 py-0.5 rounded-lg font-bold"
                            >
                              {sub}
                            </span>
                          ))}
                          {dept.subDepartments.length > 3 && (
                            <span className="bg-[#EBF7F1] text-[#2F855A] border border-[#CBE5D7] text-[10px] px-2 py-0.5 rounded-lg font-black">
                              +{dept.subDepartments.length - 3} More
                            </span>
                          )}
                        </div>
                      </div>
