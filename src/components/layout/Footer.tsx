...
export const Footer: React.FC = () => {
  ...
  const { activeTab, setActiveTab, setIsBookingOpen, isLoggedIn, openAuthModal } = useApp();
  ...
  return (
    <footer className="relative bg-[#1F1C18] text-slate-300 pt-10 pb-6 mt-12 overflow-hidden border-t border-[#36312B]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
              TrainMedix connects healthcare professionals with verified hospital training departments across India for hands-on clinical exposure, real patient interaction, and DMHCA certification.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs">
              ...
              <li>
                <button onClick={() => { setIsBookingOpen(true); setActiveTab('booking'); }} className="hover:text-[#2F855A] transition cursor-pointer">
                  Slot Calendar
                </button>
              </li>
              <li>
          ...
          {/* Contact & Helpdesk */}
          <div>
            <h5 className="text-white font-bold text-xs uppercase tracking-wider mb-4 font-heading">Training Helpdesk</h5>
            <div className="space-y-3 text-xs">
              <div className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-[#2F855A] shrink-0 mt-0.5" />
                <span>DMHCA Training HQ, Delhi NCR & Regional Hubs (Mumbai, Bangalore, Hyderabad)</span>
              </div>
              <div className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#2F855A] shrink-0" />
                <span>support@trainmedix.com</span>
              </div>
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#2F855A] shrink-0" />
                <span>+91 1800-MEDIX-BOOK</span>
              </div>
