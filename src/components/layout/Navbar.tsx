          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div ref={profileDropdownRef} className="relative">
              <button
                ...
                title={!isLoggedIn || role === 'admin' ? 'Guest (Not Logged In)' : (userProfile?.fullName || (role === 'trainee' ? 'Dr. Ananya Roy' : 'Max Hospital'))}
              >
                    ...
                    <div className="space-y-1">
                      {isLoggedIn && role === 'trainee' && (
                        <>
                          ...
                          <button
                            onClick={() => { setIsBookingOpen(true); setActiveTab('booking'); setProfileDropdownOpen(false); }}
          ...
          >
            ...
            <div className="bg-[#EBF7F1] p-3 rounded-2xl border border-[#CBE5D7]">
              ...
              <span className="text-xs font-extrabold text-slate-900 font-heading">
                {!isLoggedIn ? 'Guest (Not Signed In)' : (userProfile?.fullName || (role === 'trainee' ? 'Dr. Ananya Roy' : role === 'hospital' ? 'Max Hospital Partner' : 'System Administrator'))}
              </span>
            </div>
