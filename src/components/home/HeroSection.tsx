...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full -mt-20 pt-28 pb-16 overflow-hidden bg-[#EBF7F1]">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-[#2F855A]/10 rounded-full filter blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-80 h-80 bg-[#2F855A]/08 rounded-full filter blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-7 z-10 pt-4">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 bg-[#E2F0EA] border border-[#C5DED0] text-[#3D7A5C] text-xs font-extrabold px-4 py-2 rounded-full shadow-2xs"
            >
            ...
            >
              <motion.button
                ...
                className="group bg-[#2F855A] hover:bg-[#276749] text-white font-bold text-sm sm:text-base px-3 py-2.5 pr-7 rounded-full shadow-lg shadow-[#2F855A]/30 flex items-center gap-3 transition-all cursor-pointer"
              >
                <div className="w-10 h-10 rounded-full bg-white text-[#2F855A] flex items-center justify-center shadow-xs group-hover:translate-x-0.5 transition-transform">
              ...
              <button
                ...
                className="text-xs sm:text-sm font-bold text-slate-700 hover:text-[#2F855A] px-5 py-3 rounded-full hover:bg-slate-100/80 transition cursor-pointer"
              >
                Explore Specialties →
              </button>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-3 pl-6">
                <div className="bg-[#E2F0EA] text-[#3D7A5C] text-xs font-semibold px-4 py-2.5 rounded-2xl rounded-tl-xs border border-[#C5DED0] shadow-2xs flex items-center gap-2">
                  <span>Select hospital & duration for instant DMHCA slot 🏥</span>
                  <span className="text-[10px] text-[#2F855A] font-mono ml-1">11:34 AM</span>
                  <CheckCheck className="w-3.5 h-3.5 text-[#2F855A]" />
                </div>
              </div>

              {/* Voice Note Player */}
              <div className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-md border border-[#CBE5D7] rounded-2xl px-4 py-2.5 shadow-md">
                <button
                  onClick={() => setIsPlayingAudio(!isPlayingAudio)}
                  className="w-8 h-8 rounded-full bg-[#2F855A] text-white flex items-center justify-center hover:scale-105 transition cursor-pointer shadow-xs"
                >
                ...
                <div className="flex items-center gap-1">
                  {[40, 75, 30, 90, 60, 100, 45, 80, 50, 95, 35, 70, 40].map((h, i) => (
                    <div
                      ...
                      className={`w-1 rounded-full ${i < 6 ? 'bg-[#2F855A]' : 'bg-[#CBE5D7]'}`}
                    />
                  ))}
                </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-end min-h-[490px]">
            ...
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[45%] w-[460px] h-[460px] sm:w-[520px] sm:h-[520px] lg:w-[540px] lg:h-[540px] bg-[#2F855A] rounded-full filter blur-0 opacity-95 transition-all duration-500 shadow-xl"
              style={{
            ...
            >
              ...
              <div>
                ...
                <p className="text-[9px] text-[#2F855A] font-semibold">10:57 AM ✓✓</p>
              </div>
            </motion.div>
            ...
            >
              ...
              />
              <div className="pr-2">
                <div className="bg-[#2F855A] text-white text-[10px] font-extrabold px-3 py-1 rounded-lg">
                  Dr. Stella
                </div>
        ...
        {/* Quick Search & Slot Booking Bar */}
        <div className="mt-12 pt-8 border-t border-[#CBE5D7] relative z-30">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-center bg-white/90 backdrop-blur-md p-4 sm:p-5 rounded-3xl border border-[#CBE5D7] shadow-md relative z-30">
            ...
            <div>
              ...
              <button
                ...
                className="w-full bg-[#2F855A] hover:bg-[#276749] text-white text-xs font-bold py-3 rounded-xl transition flex items-center justify-center gap-2 shadow-md shadow-[#2F855A]/25 cursor-pointer"
              >
        ...
        {/* Metrics Counter Bar */}
        <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 relative z-0">
          <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-[#CBE5D7] text-center shadow-2xs">
            <p className="text-2xl sm:text-3xl font-black text-[#059669] font-heading">11+</p>
          ...
          <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-[#CBE5D7] text-center shadow-2xs">
            <p className="text-2xl sm:text-3xl font-black text-[#2563EB] font-heading">12,500+</p>
