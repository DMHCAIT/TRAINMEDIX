...
export const AdminLoginPage: React.FC<AdminLoginPageProps> = ({ onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 w-screen h-screen bg-gradient-to-b from-[#E6F4F6] via-slate-50 to-slate-100 flex items-center justify-center p-4 overflow-hidden select-none">
      
      {/* Decorative Emerald Glow Spheres */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#3597A4]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-72 h-72 bg-[#3597A4]/10 rounded-full blur-2xl pointer-events-none" />
      ...
      >
        ...
        <div className="text-center space-y-3">
          <div className="w-16 h-16 rounded-3xl bg-[#E6F4F6] border-2 border-[#E6F4F6] text-[#3597A4] flex items-center justify-center mx-auto shadow-lg shadow-[#3597A4]/10">
        ...
        <div className="bg-white/95 backdrop-blur-xl border border-[#E6F4F6] rounded-3xl p-6 sm:p-8 shadow-2xl shadow-slate-900/10 space-y-5">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50/80 border border-slate-300/80 rounded-2xl pl-10 pr-10 py-3 text-xs font-semibold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#3597A4] focus:ring-2 focus:ring-[#3597A4]/20 transition"
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#3597A4] hover:bg-[#1F6F76] text-white font-extrabold text-xs py-3.5 px-4 rounded-2xl transition shadow-lg shadow-[#3597A4]/25 flex items-center justify-center gap-2 cursor-pointer touch-target mt-2 disabled:opacity-70"
            >
              {isLoading ? (
          ...
          <div className="pt-2 border-t border-slate-100 text-center">
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-600 hover:text-[#3597A4] transition cursor-pointer"
            >
